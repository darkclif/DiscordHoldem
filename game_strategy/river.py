...
class RiverStrategy(InGameStrategy):
    ...
    async def setup(self):
        ...
        global_log("dbg", "T[{}] River begin.".format(game.table_id))
        game.log("game", "NEW_PHASE_START", PHASE="River")
    ...
    async def end_phase(self):
        await self.game.change_state(GameState.END_GAME)
